                    ...
                    <ul className="text-white font-archivo text-lg font-normal space-y-2">
                        <li className="cursor-pointer flex flex-row items-center gap-2.5 text-secondary">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 10C9.10457 10 10 9.10457 10 8C10 6.89543 9.10457 6 8 6C6.89543 6 6 6.89543 6 8C6 9.10457 6.89543 10 8 10Z" stroke="#8F6302" stroke-width="1.33333"/>
                                <path d="M13.4587 7.28933C13.7173 7.604 13.8467 7.76067 13.8467 8C13.8467 8.23933 13.7173 8.396 13.4587 8.71067C12.512 9.86 10.424 12 7.99999 12C5.57599 12 3.48799 9.86 2.54132 8.71067C2.28265 8.396 2.15332 8.23933 2.15332 8C2.15332 7.76067 2.28265 7.604 2.54132 7.28933C3.48799 6.14 5.57599 4 7.99999 4C10.424 4 12.512 6.14 13.4587 7.28933Z" stroke="#8F6302" stroke-width="1.33333"/>
                            </svg>
                            View
                        </li>
