  ...
  return (
    <div className='flex flex-col gap-8 mx-28 my-10'>
        <div className='flex flex-col gap-6'>
            <div>
                <h1 className='text-primary text-[40px] font-semibold font-besley'>Gallery</h1>
                <hr className='horizontal-line'/>
            </div>
            <p className='text-primary text-[20px] font-normal font-archivo'>Get a glimpse into my past meetups, where students and tech enthusiasts came together to learn, connect, and get inspired.</p>
        </div>
