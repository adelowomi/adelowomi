    ...
    <div className='px-28 py-24 flex flex-col gap-20'>
        ...
        <div className='grid grid-cols-2 content-center flex-wrap gap-16 px-20 py-4 w-[1200px]'>
            <div className='rounded-lg border-[0.5px] border-solid border-[#fcfcfc33] w-[515px]'>
                <div className='flex flex-col gap-6 p-8'>
                    <div className='w-[450px] h-[400px] rounded-lg bg-[#d9d9d9] flex justify-center items-center'>
                        <h2 className='text-black text-[48px] font-medium font-archivo'>Event Flyer</h2>
                    </div>
                    <h2 className='text-primary text-2xl font-semibold font-besley'>Event Title</h2>
                    <div className='flex flex-row gap-10'>
                        <h2 className='text-primary font-light text-sm font-archivo'>Date: 25th November </h2>
                        <h2 className='text-primary font-light text-sm font-archivo'>Time: 11am WAT</h2>
                    </div>
                    <p className='text-lg text-secondary font-normal font-archivo'>Register for Event</p>
                </div>
                <div className='flex flex-row justify-between px-8 py-3 bg-[#FFFDF8] rounded-bl-lg rounded-br-lg'>
                    <p className='text-[#5E0ACC] text-lg font-normal font-archivo'>25 tickets left</p>
                    <p className='text-[#0D0900] text-lg font-semibold font-archivo'>Ends in 360h 52m 32s</p>
                </div>
            </div>
            ...
            <div className='flex flex-col gap-6 p-8 rounded-lg border-[0.5px] border-solid border-[#fcfcfc33] w-[515px]'>
                ...
                <p className='text-lg text-secondary font-normal font-archivo'>Watch Now</p>
            </div>
