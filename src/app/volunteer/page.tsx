      ...
      <div className="min-h-screen bg-gray-50 py-8 lg:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {volunteerForms.length === 0 ? (
            ...
            <div className="grid gap-4 lg:gap-6 md:grid-cols-2 lg:grid-cols-1">
                  ...
                  <div className="p-4 lg:p-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center justify-center w-full sm:w-auto px-4 lg:px-6 py-2 lg:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm lg:text-base"
                      >
                        Apply Now
                        <svg
          ...
          <div className="mt-8 lg:mt-12 text-center">
            <div className="bg-white p-4 lg:p-6 rounded-lg shadow">
              ...
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm lg:text-base"
              >
                <svg
